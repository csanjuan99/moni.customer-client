...
<template>
  <nav :class="[ y > 0 ? '': 'bg-white']"
    ...
    <div class="flex items-center justify-between w-full h-full rounded-xl bg-white px-7 z-50">
        ...
        <article class="flex gap-10">
          ...
          <div class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input type="text" class="bg-white border-none text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-b focus:border-gray-300 block w-full pl-10 p-2.5" readonly placeholder="Search" @click=" () => { isShow = !isShow }" />
            </div>
          </div>
      ...
      <ModalsAppFilterModal :isShow="isShow"/>
    </div>
  </nav>
</template>
